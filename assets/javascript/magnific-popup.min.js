...
(
    function (e) {
        'function' == typeof define &&
            define.amd ? define(['jquery'], e) : 'object' == typeof exports ? e(require('jquery')) : e(window.jQuery || window.Zepto)
    }
)(
    function (e) {
        var t,
            ...
            k = function (t, n, i, o) {
                ...
                return r.className = 'mfp-' + t,
                    ...
                    (r.innerHTML = i),
                    o ? n &&
                        n.appendChild(r) : (r = e(r), n && r.appendTo(n)),
                    r
            },
            T = function (n, i) {
                t.ev.triggerHandler(g + n, i),
                    ...
                    (
                        ...
                        t.st.callbacks[n] &&
                        t.st.callbacks[n].apply(t, e.isArray(i) ? i : [
                            i
                        ])
                    )
            },
        ...
        w.prototype = {
            ...
            open: function (n) {
                ...
                } else t.items = e.isArray(n.items) ? n.items : [
                    n.items
                ],
                    t.index = n.index ||
                    0;
                ...
                t.types = [],
                    a = '',
                    t.ev = n.mainEl &&
                        n.mainEl.length ? n.mainEl.eq(0) : o,
                    n.key ? (
                        t.popupsCache[n.key] ||
                        (t.popupsCache[n.key] = {}),
                ...
                t.fixedContentPos &&
                    (
                        t.isIE7 ? e('body, html').css('overflow', 'hidden') : m.overflow = 'hidden'
                    );
            ...
            appendContent: function (e, n) {
                t.content = e,
                    e ? t.st.showCloseBtn &&
                        t.st.closeBtnInside &&
                        t.currTemplate[n] === !0 ? t.content.find('.mfp-close').length ||
                    t.content.append(E()) : t.content = e : t.content = '',
                    T(u),
            ...
            addGroup: function (e, n) {
                ...
                n.mainEl = e,
                    n.items ? (n.isObj = !0, e.off(o).on(o, i)) : (
                        n.isObj = !1,
            ...
            _onFocusIn: function (n) {
                return n.target === t.wrap[0] ||
                    e.contains(t.wrap[0], n.target) ? void 0 : (t._setFocus(), !1)
            },
                            ...
                            if (o = e.split('_'), o.length > 1) {
                                ...
                                if (i.length > 0) {
                                    ...
                                    'replaceWith' === r ? i[0] !== n[0] &&
                                        i.replaceWith(n) : 'img' === r ? i.is('img') ? i.attr('src', n) : i.replaceWith('<img src="' + n + '" class="' + i.attr('class') + '" />') : i.attr(o[1], n)
                                }
            ...
            e.magnificPopup = {
                ...
                close: function () {
                    return e.magnificPopup.instance &&
        ...
        var P,
            ...
            B = function () {
                z &&
                    (O.after(z.addClass(P)).detach(), z = null)
            };
                        ...
                        var n = 0,
                            ...
                            o = function (r) {
                                j &&
                                    ...
                                    j = setInterval(
                                        function () {
                                            return i.naturalWidth > 0 ? (t._onImageHasSize(e), void 0) : (
                                                n > 200 &&
                                                clearInterval(j),
                                                n++,
                                                3 === n ? o(10) : 40 === n ? o(50) : 100 === n &&
                                                    o(500),
                                                void 0
                                            )
                                        },
                    ...
                    getImage: function (n, i) {
                        ...
                        if (l.length) {
                            ...
                            c.className = 'mfp-img',
                                ...
                                (n.img = n.img.clone()),
                                c = n.img[0],
                                c.naturalWidth > 0 ? n.hasSize = !0 : c.width ||
                                    (n.hasSize = !1)
                        }
                        return t._parseMarkup(i, {
                            ...
                            n.hasSize ? (
                                ...
                                n.loading = !0,
                                n.hasSize ||
                                (n.imgHidden = !0, i.addClass('mfp-loading'), t.findImageSize(n)),
                                i
                            )
                    }
                }
                                    ...
                                    function () {
                                        n.navigateByImgClick &&
                                            ...
                                            o.on(
                                                'keydown' + i,
                                                function (e) {
                                                    37 === e.keyCode ? t.prev() : 39 === e.keyCode &&
                                                        t.next()
                                                }
                                            )
                                    }
