!function (t, e) {
    'object' == typeof exports &&
        'undefined' != typeof module ? e(exports) : 'function' == typeof define &&
    ...
    function (e) {
        ...
        function ia(t) {
            return Math.round(100000 * t) / 100000 ||
                0
        }
        function ja(t) {
            return Math.round(10000000 * t) / 10000000 ||
                0
        }
        function ka(t, e) {
            var r = e.charAt(0),
        ...
        function ma() {
            var t,
                ...
                r = dt.length,
                i = dt.slice(0);
            for (ct = {}, t = dt.length = 0; t < r; t++) (e = i[t]) &&
                e._lazy &&
        ...
        function oa(t) {
            var e = parseFloat(t);
            return (e || 0 === e) &&
                (t + '').match(at).length < 2 ? e : r(t) ? t.trim() : t
        }
        function pa(t) {
            return t
        }
        function qa(t, e) {
            for (var r in e) r in t ||
                (t[r] = e[r]);
            return t
        }
        function ta(t, e) {
            for (var r in e) '__proto__' !== r &&
                'constructor' !== r &&
                'prototype' !== r &&
        ...
        function Ca(t, e, r, i) {
            return t._startAt &&
                (
                    L ? t._startAt.revert(ht) : t.vars.immediateRender &&
                        !t.vars.autoRevert ||
        ...
        function Ja(t, e) {
            ...
            if (
                ...
                if (t._dur < t.duration()) for (r = t; r._dp;) 0 <= r.rawTime() &&
        ...
        function Ra(t, e, r, i) {
            ...
            return s &&
                ...
                (t._time *= a / t._dur),
                t._dur = a,
                t._tDur = n ? n < 0 ? 10000000000 : ja(a * (n + 1) + t._rDelay * n) : a,
                0 < s &&
                !i &&
                Ia(t, t._tTime = t._tDur * s),
                t.parent &&
                Ha(t),
                r ||
                Aa(t.parent, t),
        ...
        function cb(r) {
                ...
                R('Invalid scope') ||
            {
                ...
                function (t) {
                    ...
                    return Mt(
                        t,
                        e.querySelectorAll ? e : e === r ? R('Invalid scope') ||
                ...
                function (t, e, r) {
                    ...
                    if (!c) {
                        ...
                        'random' === m &&
                            ...
                            c.b = d < 0 ? g - d : g,
                            c.u = Ya(p.amount || p.each) ||
                            0,
                            _ = _ &&
                                d < 0 ? Yt(_) : _
                    }
                    return d = (c[t] - c.min) / c.max ||
                        0,
        ...
        function hb(t, e, r, i) {
            return Wa(
                Z(t) ? !e : !0 === r ? !!(r = 0) : !i,
                function () {
                    return Z(t) ? t[~~(Math.random() * t.length)] : (r = r || 0.00001) &&
        ...
        function ob(t) {
            for (var e, r, i, n, a = 0, s = ''; ~(e = t.indexOf('random(', a));) i = t.indexOf(')', e),
                ...
                s += t.substr(a, e - a) + hb(n ? r : + r[0], n ? 0 : + r[1], + r[2] || 0.00001),
                a = i + 1;
        ...
        function zb(t, e, r) {
            return (
                6 * (t += t < 0 ? 1 : 1 < t ? - 1 : 0) < 1 ? e + (r - e) * t * 6 : t < 0.5 ? r : 3 * t < 2 ? e + (r - e) * (2 / 3 - t) * 6 : e
            ) * St + 0.5 | 0
        }
        function Ab(e, r, i) {
            var n,
        ...
        function Cb(t, e, r) {
            ...
            if (
                ...
                r &&
                (a = Bb(t), (i = r.c).join(o) !== a.c.join(o))
            ) for (s = (n = t.replace(Et, '1').split(rt)).length - 1; l < s; l++) o += n[l] + (
                ~i.indexOf(l) ? u.shift() ||
                    h + '0,0,0,0)' : (a.length ? a : u.length ? u : r).shift()
            );
        ...
        function Fb(t) {
            var e,
                r = t.join(' ');
            if (Et.lastIndex = 0, Et.test(r)) return e = Dt.test(r),
                t[1] = Cb(t[1], e),
                t[0] = Cb(t[0], e, Bb(t[1])),
                !0
        }
        function Ob(t) {
            ...
            return r &&
                ...
                r.config ? r.config.apply(
                    ...
                    It.test(t) ? Lt._CE('', t) : r
        }
        function Qb(t, e) {
            for (var r, i = t._first; i;) i instanceof Xt ? Qb(i, e) : !i.vars.yoyoEase ||
                i._yoyo &&
                i._repeat ||
                i._yoyo === e ||
                (
        ...
        var F,
            ...
            Mt = function toArray(t, e, i) {
                return l &&
                    !e &&
                    l.selector ? l.selector(t) : !r(t) ||
                        i ||
                        !n &&
                        Ft() ? Z(t) ? function _flatten(t, e, i) {
                            return void 0 === i &&
                                (i = []),
                                t.forEach(
                                    function (t) {
                                        return r(t) &&
                                            !e ||
                                            _a(t, 1) ? i.push.apply(i, Mt(t)) : i.push(t)
                                    }
                                ) ||
                                i
                    ...
                    wake: function wake() {
                        o &&
                            (
                                ...
                                _ = m ||
                                function (t) {
                                    return setTimeout(t, D - 1000 * g.time + 1 | 0)
                                },
                                c = 1,
                                yl(2)
                            )
        ...
        var qt,
            ...
            Ut = (
                ...
                qt.duration = function duration(t) {
                    return arguments.length ? this.totalDuration(0 < this._repeat ? t + (t + this._rDelay) * this._repeat : t) : this.totalDuration() &&
                        this._dur
                },
                ...
                qt.totalTime = function totalTime(t, e) {
                    ...
                    if (r && r.smoothChildTiming && this._ts) {
                        for (Ia(this, t), !r._dp || r.parent || Ja(r, this); r && r.parent;) r.parent._time !== r._start + (0 <= r._ts ? r._tTime / r._ts : (r.totalDuration() - r._tTime) / - r._ts) &&
                ...
                qt.progress = function progress(t, e) {
                    return arguments.length ? this.totalTime(
                        ...
                        e
                    ) : this.duration() ? Math.min(1, this._time / this._dur) : 0 < this.rawTime() ? 1 : 0
                },
                ...
                qt.timeScale = function timeScale(t, e) {
                    ...
                    var r = this.parent &&
                        this._ts ? Ga(this.parent._time, this) : this._tTime;
                    return this._rts = + t ||
                        0,
                        this._ts = this._ps ||
                            t === - X ? 0 : this._rts,
                ...
                qt.rawTime = function rawTime(t) {
                    var e = this.parent ||
                        this._dp;
                    return e ? t &&
                        (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? Ga(e.rawTime(t), this) : this._tTime : this._tTime
                },
                ...
                qt.globalTime = function globalTime(t) {
                    for (var e = this, r = arguments.length ? t : e.rawTime(); e;) r = e._start + r / (Math.abs(e._ts) || 1),
                        e = e._dp;
                    return !this.parent &&
                        this._sat ? this._sat.globalTime(t) : r
                },
        ...
        var Xt = function (i) {
            function Timeline(t, e) {
                ...
                return void 0 === t &&
                    ...
                    I &&
                    Ka(t.parent || I, _assertThisInitialized(r), e),
                    t.reversed &&
                    r.reverse(),
                    t.paused &&
                    r.paused(!0),
            ...
            return e.to = function to(t, e, r) {
                ...
                e.render = function render(t, e, r) {
                    ...
                    if (this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y) {
                        if (
                            ...
                            u = !(l = this._ts),
                            y &&
                            (g || (_ = this._zTime), !t && e || (this._zTime = t)),
                            this._repeat
                        ) {
                        ...
                        if (_ <= i && 0 <= t) for (n = this._first; n;) {
                            if (a = n._next, (n._act || i >= n._start) && n._ts && h !== n) {
                                ...
                                if (
                                    n.render(
                                        0 < n._ts ? (i - n._start) * n._ts : (n._dirty ? n.totalDuration() : n._tDur) + (i - n._start) * n._ts,
                                        e,
                                        r
                                    ),
                                    i !== this._time ||
                ...
                e.getChildren = function getChildren(t, e, r, i) {
                    ...
                    for (var n = [], a = this._first; a;) a._start >= i &&
                        (
                            a instanceof $t ? e &&
                                n.push(a) : (r && n.push(a), t && n.push.apply(n, a.getChildren(!0, e, r)))
                        ),
                        a = a._next;
                    return n
                },
                ...
                e.removePause = function removePause(t) {
                    var e = this._first;
                    for (t = xt(this, t); e;) e._start === t &&
                        'isPause' === e.data &&
                        za(e),
                        e = e._next
                },
                e.killTweensOf = function killTweensOf(t, e, r) {
                    for (var i = this.getTweensOf(t, r), n = i.length; n--;) Nt !== i[n] &&
                        i[n].kill(t, e);
                    return this
                },
                e.getTweensOf = function getTweensOf(e, r) {
                    for (var i, n = [], a = Mt(e), s = this._first, o = t(r); s;) s instanceof $t ? la(s._targets, a) &&
                        (
                            o ? (!Nt || s._initted && s._ts) &&
                                s.globalTime(0) <= r &&
                                s.globalTime(s.totalDuration()) > r : !r ||
                            s.isActive()
                        ) &&
                        n.push(s) : (i = s.getTweensOf(a, r)).length &&
                    n.push.apply(n, i),
                        s = s._next;
                    return n
                },
                ...
                e.shiftChildren = function shiftChildren(t, e, r) {
                    void 0 === r &&
                        (r = 0);
                    for (var i, n = this._first, a = this.labels; n;) n._start >= r &&
                        (n._start += t, n._end += t),
                        n = n._next;
                    if (e) for (i in a) a[i] >= r &&
                        (a[i] += t);
                    return Aa(this)
                },
                ...
                e.totalDuration = function totalDuration(t) {
                    var e,
                        ...
                        s = a._last,
                        o = U;
                    if (arguments.length) return a.timeScale(
                    ...
                    if (a._dirty) {
                        for (i = a.parent; s;) e = s._prev,
                            ...
                            o < (r = s._start) &&
                                a._sort &&
                                s._ts &&
                                !a._lock ? (a._lock = 1, Ka(a, s, r - s._delay, 1)._lock = 0) : o = r,
                            r < 0 &&
                            s._ts &&
                            (
                                n -= r,
        ...
        var Nt,
            ...
            Wt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
                ...
                var d,
                    c = t[e],
                    p = 'get' !== i ? i : s(c) ? l ? t[e.indexOf('set') ||
                        !s(t['get' + e.substr(3)]) ? e : 'get' + e.substr(3)](l) : t[e]() : c,
                    _ = s(c) ? l ? re : te : Zt;
                if (
                    r(n) &&
                    (
            ...
            Qt = function _initTween(t, e, r) {
                var i,
                    ...
                    S = t.parent,
                    z = S &&
                        'nested' === S.data ? S.vars.targets : A,
                    E = 'auto' === t._overwrite &&
                        !F,
                    D = t.timeline;
                if (
                    ...
                    if (
                        ...
                        (
                            ...
                            e < 0 &&
                                x &&
                                y &&
                                !M ? C.render(- 1, !0) : C.revert(x && P ? ht : ut),
                            C._lazy = 0
                        ),
                        v
                    ) {
                        ...
                        t._startAt._sat = t,
                        e < 0 &&
                        (L ? t._startAt.revert(ht) : t._startAt.render(- 1, !0)),
                        t._zTime = e,
                        y
                    ) {
                        if (!e) return
                    ...
                    for (t._pt = t._ptCache = 0, T = P && w(T) || T && !P, n = 0; n < A.length; n++) {
                        if (
                            ...
                            (f = ac(a, i, t, c, o, z)) ? f.priority &&
                        (u = 1) : d[a] = s = Wt.call(t, o, a, 'get', i[a], c, z, 0, m.stringFilter);
                        t._op &&
                            t._op[n] &&
                            t.kill(o, t._op[n]),
                            E &&
            ...
            Kt = function _parseFuncOrString(t, e, i, n, a) {
                return s(t) ? t.call(e, i, n, a) : r(t) &&
                    ~t.indexOf('random(') ? ob(t) : t
            },
                    ...
                    if (
                        ...
                        (
                            s = a.timeline = new Xt({
                                ...
                                targets: P &&
                                    'nested' === P.data ? P.vars.targets : C
                            })
                        ).kill(),
                        ...
                        if (h = C.length, d = T && eb(T), v(T)) for (l in T) ~Jt.indexOf(l) &&
                            ((c = c || {
                            })[l] = T[l]);
                        for (o = 0; o < h; o++) (u = ua(r, Ht)).stagger = 0,
                            M &&
                            (u.yoyoEase = M),
                            c &&
                            yt(u, c),
            ...
            return e.render = function render(t, e, r) {
                ...
                if (p) {
                    if (
                        ...
                        for (n = this._pt; n;) n.r(h, n.d),
                            n = n._next;
                        l &&
                            l.render(t < 0 ? t : !i && u ? - X : l._dur * l._ease(i / this._dur), e, r) ||
                            this._startAt &&
                            (this._zTime = t),
                            this._onUpdate &&
                            !e &&
                ...
                e.resetTo = function resetTo(t, e, r, i, n) {
                    ...
                    return this._initted ||
                        ...
                        function _updatePropTweens(t, e, r, i, n, a, s, o) {
                            ...
                            for (f = d.length; f--;) (u = (h = d[f])._pt || h).s = !i &&
                                0 !== i ||
                                n ? u.s + (i || 0) + a * u.c : i,
                                u.c = r - u.s,
                                h.e &&
                                ...
                                h.b &&
                                (h.b = u.s + Ya(h.b))
                        }(this, t, e, r, i, a, s, n) ? this.resetTo(t, e, r, i, 1) : (
                            Ia(this, 0),
                            this.parent ||
                ...
                e.kill = function kill(t, e) {
                    ...
                    if (this.timeline) {
                        ...
                        return this.timeline.killTweensOf(t, e, Nt && !0 !== Nt.vars.overwrite)._first ||
                            tb(this),
                            this.parent &&
                    ...
                    for (
                        ...
                        l = f.length;
                        l--;
                    ) if (~d.indexOf(f[l])) for (
                        u in a = c[l],
                        'all' === e ? (n[l] = e, o = a, s = {}) : (s = n[l] = n[l] || {
                        }, o = e),
                        o
                    ) (h = a && a[u]) &&
        ...
        var Zt = function _setterPlain(t, e, r) {
            ...
            ne = function _getSetter(t, e) {
                return s(t[e]) ? te : u(t[e]) &&
                    t.setAttribute ? oc : Zt
            },
            ...
            ue = function _renderComplexString(t, e) {
                ...
                if (!t && e.b) i = e.b;
                    ...
                    for (; r;) i = r.p + (r.m ? r.m(r.s + r.c * t) : Math.round(10000 * (r.s + r.c * t)) / 10000) + i,
                        r = r._next;
                    i += e.c
                }
                e.set(e.t, e.p, i, e)
                    ...
                    ge.forEach(
                        function (t) {
                            var e,
                                ...
                                a = t.queries,
                                s = t.conditions;
                            for (r in a) (e = h.matchMedia(a[r]).matches) &&
                                (i = 1),
                                e !== s[r] &&
                                (s[r] = e, n = 1);
                            n &&
            ...
            Pe = (
                ...
                me.getTweens = function getTweens() {
                    ...
                    return this.data.forEach(
                        function (t) {
                            return t instanceof Context ? e.push.apply(e, t.getTweens()) : t instanceof $t &&
                ...
                me.kill = function kill(i, t) {
                    ...
                    if (
                        i ? function () {
                            for (var t, e = n.getTweens(), r = n.data.length; r--;) 'isFlip' === (t = n.data[r]).data &&
                                (
                                    t.revert(),
                            ...
                            for (
                                    ...
                                    function (t) {
                                        return {
                                            g: t._dur ||
                                                t._delay ||
                                                t._sat &&
                                                !t._sat.vars.immediateRender ? t.globalTime(0) : - 1 / 0,
                                            t: t
                                        }
                                    }
                                ).sort(function (t, e) {
                                ...
                                r = n.data.length;
                                r--;
                            ) (t = n.data[r]) instanceof Xt ? 'nested' !== t.data &&
                                (t.scrollTrigger && t.scrollTrigger.revert(), t.kill()) : t instanceof $t ||
                                !t.revert ||
                            t.revert(i);
                        ...
                        this.clear(),
                        t
                    ) for (var e = ge.length; e--;) ge[e].id === this.id &&
                        ge.splice(e, 1)
                },
            ...
            Ae = (
                (Ce = MatchMedia.prototype).add = function add(t, e, r) {
                    ...
                    for (
                        n in l &&
                        !s.selector &&
                        (s.selector = l.selector),
                        this.contexts.push(s),
                        e = s.add('onMatch', e),
                        s.queries = t
                    ) 'all' === n ? a = 1 : (i = h.matchMedia(t[n])) &&
                        (
                            ge.indexOf(s) < 0 &&
                            ge.push(s),
                            (o[n] = i.matches) &&
                    ...
                    e._onInit = function (t) {
                        ...
                        !function _addModifiers(t, e) {
                            var r,
                                ...
                                n,
                                a = t._targets;
                            for (r in e) for (i = a.length; i--;) (n = (n = t._ptLookup[i][r]) && n.d) &&
        ...
        var ze = Se.registerPlugin({
            ...
            render: function render(t, e) {
                for (var r = e._pt; r;) L ? r.set(r.t, r.p, r.b, r) : r.r(t, r.d),
                    r = r._next
            }
        }, {
            name: 'endArray',
        ...
        }, Lc('roundProps', fb), Lc('modifiers'), Lc('snap', gb)) ||
            Se;
        $t.version = Xt.version = ze.version = '3.12.4',
            o = 1,
            x() &&
            Ft();
        function vd(t, e) {
        ...
        function Jd(t, e) {
            ...
            if (t in ar && n) {
                ...
                }, 'transform' === t) return dr.transform.split(',').forEach(function (t) {
                    return Jd.call(r, t, e)
                });
                if (
                    ~(t = dr[t] || t).indexOf(',') ? t.split(',').forEach(function (t) {
                        return r.tfm[t] = yr(i, t)
                    }) : this.tfm[t] = a.x ? a[t] : yr(i, t),
                    t === pr &&
                    (this.tfm.zOrigin = a.zOrigin),
        ...
        function Ld() {
            var t,
                ...
                n = i.style,
                a = i._gsap;
            for (t = 0; t < r.length; t += 3) r[t + 1] ? i[r[t]] = r[t + 2] : r[t + 2] ? n[r[t]] = r[t + 2] : n.removeProperty(
        ...
        function Od(t, e) {
            var r = De.createElementNS ? De.createElementNS(
                (e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'),
                t
            ) : De.createElement(t);
            return r &&
                r.style ? r : De.createElement(t)
        }
        function Pd(t, e, r) {
        ...
        function Td(t) {
            ...
            if (
                ...
                (e = this._gsapBBox());
            return i &&
                (n ? i.insertBefore(this, n) : i.appendChild(this)),
                Re.removeChild(r),
        ...
        function be(t, e, r, i) {
            if (!r || 'none' === r) {
                var n = mr(e, t, 1),
                    a = n &&
                        Pd(t, n, 1);
                a &&
                    a !== r ? (e = n, r = a) : 'borderColor' === e &&
                (r = Pd(t, 'borderTopColor'))
            }
            var s,
                o,
                u,
            ...
            if (
                ...
                for (; o = rt.exec(i);) d = o[0],
                    p = i.substring(v, o.index),
                    l ? l = (l + 1) % 5 : 'rgba(' !== p.substr(- 5) &&
                        'hsla(' !== p.substr(- 5) ||
                        (l = 1),
                    d !== (f = u[y++] || '') &&
                    (
                        ...
                        _ ||
                        (_ = _ || q.units[e] || m, v === i.length && (i += _, g.e += _)),
                        m !== _ &&
                        (h = _d(t, e, f, _) || 0),
                        g._pt = {
                            _next: g._pt,
        ...
        function ke(t, e) {
            var r,
                ...
                u = je(t);
            return s.svg &&
                t.getAttribute('transform') ? '1,0,0,1,0,0' === (
                    u = [
        ...
        function le(t, e, r, i, n, a) {
            ...
            r ? l !== wr &&
                ...
                i ||
                    !1 !== i &&
                    h.smooth ? (y = w - f, T = x - d, h.xOffset = c + (y * _ + T * g) - y, h.yOffset = p + (y * m + T * v) - T) : h.xOffset = h.yOffset = 0,
                h.xOrigin = w,
                h.yOrigin = x,
                h.smooth = !!i,
                h.origin = e,
        ...
        function ve(t, e, i, n, a) {
            ...
            return h &&
                (
                    ...
                    (l += l < 0 ? u : - u),
                    'cw' === s &&
                        l < 0 ? l = (l + 36000000000) % u - ~~(l / u) * u : 'ccw' === s &&
                        0 < l &&
                    (l = (l - 36000000000) % u - ~~(l / u) * u)
                ),
        ...
        var Ee,
            ...
            Or = function _parseTransform(t, e) {
                ...
                return i = n = a = u = h = l = f = d = c = 0,
                    ...
                    r.svg &&
                    (
                        M = r.uncache ? (P = t.getBBox(), Y = r.xOrigin - P.x + 'px ' + (r.yOrigin - P.y) + 'px', '') : !e &&
                    ...
                    (
                        ...
                        6 === m.length ? (
                            ...
                            g = ur(O, k),
                            f = 0.0002 < Math.abs(g) ? g * sr : 0,
                            c = D ? 1 / (D < 0 ? - D : D) : 0
                        ),
                        r.svg &&
                        (
                            M = t.getAttribute('transform'),
                            r.forceCSS = t.setAttribute('transform', '') ||
                            !ie(Pd(t, cr)),
                            M &&
                            t.setAttribute('transform', M)
                        )
                    ),
                    90 < Math.abs(f) &&
                    Math.abs(f) < 270 &&
                    ...
                    r.x = i - (
                        ...
                        ) ? t.offsetWidth * r.xPercent / 100 : 0
                    ) + 'px',
                    r.y = n - (
                        (
                            r.yPercent = n &&
                        ...
                        ) ? t.offsetHeight * r.yPercent / 100 : 0
                    ) + 'px',
                    r.z = a + 'px',
                    r.scaleX = ia(s),
                    r.scaleY = ia(o),
            ...
            Sr = function _renderCSSTransforms(t, e) {
                ...
                _ !== Cr &&
                    ...
                    (
                        y += o !== Cr ||
                            T ? 'translate3d(' + a + ', ' + s + ', ' + o + ') ' : 'translate(' + a + ', ' + s + Ar
                    ),
                    u !== Pr &&
                    (y += 'rotate(' + u + Ar),
                    h !== Pr &&
            ...
            zr = function _renderSVGTransforms(t, e) {
                ...
                d = parseFloat(d),
                    ...
                    (u || h) &&
                    (s = g.getBBox(), x = ia(x + u / 100 * s.width), O = ia(O + h / 100 * s.height)),
            ...
            Fr = {
                ...
                init: function init(t, e, i, n, a) {
                    ...
                    for (
                        ...
                        this.tween = i,
                        e
                    ) if ('autoRound' !== d && (o = e[d], !pt[d] || !ac(d, e, i, n, t, a))) if (
                        l = typeof o,
                        f = br[d],
                        'function' === l &&
                        ...
                        (T = 1);
                    else if ('--' === d.substr(0, 2)) s = (getComputedStyle(t).getPropertyValue(d) + '').trim(),
                        o += '',
                        Et.lastIndex = 0,
                        Et.test(s) ||
                        (c = Ya(s), p = Ya(o)),
                        ...
                        if (
                            ...
                            m = d in ar
                                ...
                                (d = mr(d) || d);
                        if (m || (u || 0 === u) && (h || 0 === h) && !fr.test(o) && d in x) u = u ||
                            0,
                        ...
                        m ||
                            (d in x ? b.push(d, 0, x[d]) : b.push(d, 1, s || t[d])),
                            w.push(d)
                    }
                    T &&
                        pe(this)
                ...
                render: function render(t, e) {
                    if (e.tween._time || !Be()) for (var r = e._pt; r;) r.r(t, r.d),
                        r = r._next;
                ...
                getSetter: function getSetter(t, e, r) {
                    ...
                    return i &&
                        ...
                        e in ar &&
                            e !== pr &&
                            (t._gsap.x || yr(t, 'x')) ? r &&
                                Ie === r ? 'scale' === e ? Ed : Dd : (Ie = r || {
                                }) &&
                        ('scale' === e ? Fd : Gd) : t.style &&
                            !u(t.style[e]) ? Bd : ~e.indexOf('-') ? Cd : ne(t, e)
                },
                core: {
                    _removeProperty: Xd,
                    _getMatrix: ke
